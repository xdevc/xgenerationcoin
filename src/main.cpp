...
unsigned int nStakeMaxAge = 16 * 60 * 60; // 16 hours
...
const string strMessageMagic = "XGenerationCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "XGenerationCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "21 May 2014";
        CTransaction txNew;
        txNew.nTime = 1400691600;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1400691600;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 733548  : 733548 ;	
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x5142f447f6244b6ae00ceb9f9c2d3d91d69d7f95a7699d4ff5093c5c86230758"));		
        block.print();
