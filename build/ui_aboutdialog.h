...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        versionLabel->setText(QStringLiteral("1.0.2.0"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About XGenerationCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>XGenerationCoin</b> version", 0));
...
"Copyright \302\251 2014 The XGenerationCoin developers", 0));
