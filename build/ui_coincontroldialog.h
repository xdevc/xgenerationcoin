...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 XGEN"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 XGEN"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 XGEN"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 XGEN"));
